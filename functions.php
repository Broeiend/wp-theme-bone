...
function enqueue_css() {
    ...
    wp_register_style( 'style', get_template_directory_uri() . '/style.css', false, null, 'screen, projection' );
    ...
    // wp_register_style( 'print', get_template_directory_uri() . '/stylesheets/print.css', false, null, 'print' );
